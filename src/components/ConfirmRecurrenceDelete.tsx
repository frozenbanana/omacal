...
export function ConfirmRecurrenceDelete({
  isInstance,
  title,
  onClose,
  onDeleteSingle,
      ...
      <div className="modal" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 460 }}>
        ...
        <div style={{ display: "grid", gap: "0.45rem", marginTop: "0.8rem" }}>
            ...
            <>
              ...
              >
                ...
                <div className="muted" style={{ fontSize: "0.72rem" }}>
                  Hide this occurrence (adds EXDATE). Others stay.
                </div>
              </button>
              <button
                type="button"
              ...
              >
                ...
                <div className="muted" style={{ fontSize: "0.72rem" }}>
                  Truncate series before this date (sets UNTIL). Keeps earlier events.
                </div>
              </button>
            </>
          )}
          ...
          >
            ...
            <div className="muted" style={{ fontSize: "0.72rem" }}>
              {isInstance ? "Delete all occurrences." : "Delete every occurrence of this event."}
            </div>
          </button>
